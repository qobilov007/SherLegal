...
export default function page() {
  ...
  return (
    <section className="container md:mt-[124px] mt-[104px]">
      ...
      <div className=" md:p-6 p-4 m-auto rounded-2xl max-w-4xl smd:bg-white smd:shadow-xl lg:mb-[64px] md:mb-[44px] mb-[24px]  ">
        ...
        <div className="md:space-y-4 space-y-3">
          ...
          <p className="font-inter font-bold leading-[140%] text-[16px]">
            {t("title2")}
          </p>
