      ...
      <div className="home-prev">
        ...
        <div className="container h-screen flex flex-col justify-center gap-14">
          <div className="pt-[130px]">
            <div className="inline-flex max-w-[45%] flex-col justify-center text-white relative z-10">
              <article className="w-[270px] flex items-center gap-2 px-6 py-4 rounded-full glass border bg-red-400">
                <svg
              ...
              <h2 className="text-[56px] leading-[120%] font-inter font-medium text-white">
                Law and Attorney Firm in Tashkent -
              </h2>
              <article className="flex items-center gap-1">
                <p className="font-inter flex items-center justify-center text-[56px] border-[2px] border-solid border-[#ff6363] h-[75px] px-3 rounded-[20px] bg-[linear-gradient(90deg,#CB1612_0%,#650B09_100%)] font-bold">
                  Sher
                </p>
                <span className="font-inter text-[56px] py-2 px-3 font-bold">
                  Legal
                </span>
              </article>
              <p className="text-[#cacaca] font-inter text-base font-normal leading-[130%] mb-5">
                ...
                solutionsto protect your rights and achieve your goals.
              </p>
          ...
          <div className="relative w-full flex justify-center items-center py-5">
            ...
            <div className="relative w-full flex justify-evenly gap-10 md:gap-16 text-white">
              {stats.map((item, i) => (
