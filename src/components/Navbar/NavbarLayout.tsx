...
import { Globe } from "lucide-react"; // lucide-react icon
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-1 px-3 py-2 rounded-full bg-gray-700/50 text-white"
                        >
                            <Globe size={16} />
                            <span>En</span>
                            <svg
                        ...
                        {langOpen && (
                            <ul className="absolute right-0 mt-2 w-24 bg-white text-black rounded-lg shadow-lg">
                                <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer">En</li>
                                <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer">Ru</li>
                                <li className="px-3 py-2 hover:bg-gray-100 cursor-pointer">Uz</li>
                            </ul>
                        )}
                    </div>
