...
export default function Hero() {
  ...
  const askAI = async () => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "ai", text: "Xatolik yuz berdi, keyinroq urinib ko‘ring." },
      ]);
    } finally {
      setLoading(false);
  ...
  return (
    <section className="flex flex-col items-center justify-center h-[866px] bg-legalai">
      ...
      >
        <div className="rounded-[36px] bg-[#000] bg-cardAi  text-white p-6 text-center">
          <article className="inline-flex items-center gap-2 px-4 py-2 rounded-full border bg-white/10">
            <svg
              width="20"
              height="27"
              viewBox="0 0 20 27"
    ...
    border-0 border-b border-gray-600 focus:border-blue-500 focus:ring-0 outline-none transition"
            ...
            <div onClick={() => {
              ...
              >
                <path
                  d="M7.50002 2V16M7.50002 2L1.66669 7.83333M7.50002 2L13.3334 7.83333"
                  stroke="white"
                  strokeWidth="2.5"
                  strokeLinecap="round"
