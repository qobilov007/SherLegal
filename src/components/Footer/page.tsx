...
export default function FooterPage() {
  return (
    <div className=" w-full footer-overlay pt-[100px]">
      <div className="container">
        <article className="relative z-[11] max-w-[730px] m-auto mb-[129px]">
          <h3 className="font-inter font-bold text-[64px] leading-[76px] text-white text-center mb-6">
            Law and Attorney Firm in Tashkent -SherLegal
          </h3>
          <p className="max-w-[68%] m-auto font-normal text-[16px] font-inter leading-[20px] text-center text-white/80 mb-6">
          ...
          <article className="flex items-center gap-5 justify-center">
            <button className="px-7 py-4 rounded-full border-l border-t border-r backdrop-blur-lg text-[16px] font-medium font-inter leading-[20px] text-white">
              About us
            </button>
            <button className="px-6 py-4 rounded-full bg-[#C61511] hover:shadow-lg transition-all duration-200 hover:shadow-[#C61511] text-[16px] font-medium font-inter leading-[20px] text-white">
              Contact us
            </button>
          </article>
        </article>
      </div>
      <div className="container relative z-[11] w-full grid grid-cols-3 gap-24">
        <div>
          <Image className="mb-6" src={Logo} alt="Logo SherLegal" />
          <p className="font-inter font-normal text-[16px] leading-[22px] text-white/60 mb-9">
            Our law firm combines legal expertise with personalized solutions to
            protect your rights and achieve your goals.
          </p>
          <div>
        ...
        <article className="flex items-start gap-24">
          <ul>
        ...
        <div className="p-5 rounded-3xl backdrop-blur-[20px] flex flex-col gap-5 border-2 border-[rgba(255,255,255,0.10)] mb-20">
      ...
      <p className="container relative z-[11] text-white/60 pb-[23px]">Copyright 2024 - “Sherlegal” LLC</p>
    </div>
  );
}
