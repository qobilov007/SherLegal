...
export default function ReviewMediaCard({
  ...
  return (
    <article
      ...
      className="relative cursor-pointer ml-6 rounded-[32px] p-2 max-w-[300px] max-h-[250px] min-h-[250px] transition-all duration-300 shadow-effect border-2 border-[rgba(255,255,255,0.13)] backdrop-blur-[12px]"
    >
