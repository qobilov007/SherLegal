  ...
  return (
    <div className="relative pb-20 xl:pt-16 pt-0 sm:pb-28 md:pb-32 bg-[rgba(255,255,255,1)]">
      ...
      <div className="bgcolorr container relative left-0 max-lg:p-4 xl:flex max-xl:flex-col items-center justify-between w-full bg-[#0653C9] lg:rounded-[36px] rounded-2xl">
        ...
        {/* Contact Form */}
        <div className="flexshrink w-full lg:w-[550px] max-md:py-0 py-6 px-4 sm:px-6 md:px-8 lg:mt-0 border xl:absolute xl:right-16 h-auto xl:h-[550px] relative bg-[#fff] border-[rgba(255,255,255,0.5)] z-100 xl:rounded-[36px] rounded-2xl">
          <article className="">
