  ...
  return (
    <div className="relative pb-20 xl:pt-16 pt-0 sm:pb-28 md:pb-32 bg-[rgba(255,255,255,1)]">
      ...
      <div className="bgcolorr container relative left-0 max-lg:p-4 xl:flex max-xl:flex-col items-center justify-between w-full bg-[#0653C9] lg:rounded-[36px] rounded-2xl">
            ...
            >
              <article className="p-2 sm:p-[9px] flex items-center gap-[10px] rounded-full bg-[rgba(19,123,234,0.12)]">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.5 20.5L3.5 17.5V4.5L9.5 7.5M9.5 20.5L15.5 17.5M9.5 20.5V7.5M15.5 17.5L21.5 20.5V7.5L15.5 4.5M15.5 17.5V4.5M9.5 7.5L15.5 4.5" stroke="#137BEA" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </article>
              <article>
        ...
        {/* Contact Form */}
        <div className="flexshrink w-full lg:w-[550px] max-md:py-0 py-6 px-8 sm:px-6 md:px-8 lg:mt-0 border xl:absolute xl:right-16 h-auto xl:h-[550px] relative bg-[#fff] border-[rgba(255,255,255,0.5)] z-100 xl:rounded-[36px] rounded-2xl">
          <article className="">
